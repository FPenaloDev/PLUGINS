export function desplegableImportante(container, datos) {

    //CSS
    const css = document.createElement('link');
    css.rel = 'stylesheet';
    css.type = 'text/css';
    css.href = 'PLUGINS/DESPLEGABLE/IMPORTANTE/desplegable_importante.css';
    ...
    <div class="main">
        <h2 id="Titulo"><span>IMPORTANTE</span><img src="${datos[nDesplegables].icono}" width="30" height="30" style="margin-left: auto;" /></h2>
        <div id="desplegable1">
        ${datos.map(dato => {
        switch (dato.tipo) {
            case "parrafo":
