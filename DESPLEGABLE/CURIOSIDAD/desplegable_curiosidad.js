export function desplegableCuriosidad(container, datos) {
    ...
    const contenidoHTML = `
    <div class="main">
        <h2 id="Titulo"><span>CURIOSIDAD</span><img src="${datos.imagen}" width="30" height="30" style="margin-left: auto;" /></h2>
        <div id="desplegable1">
            ${datos.map(dato => {
        switch (dato.tipo) {
            case "parrafo":
